    ...
    const moduleQuestions = [
      {
        name: 'templateType',
        type: 'list',
        message: chalk.blueBright(`${chalk.yellow('Extend content type')} OR create ${chalk.yellow('custom content type')}?`),
      ...
      },
      {
        name: 'contentType',
        type: 'list',
        message: chalk.blueBright(`Choose a ${chalk.yellow('Page Builder content type')} to extend:`),
      ...
      },
      {
        name: 'contentType',
        type: 'input',
        message: chalk.blueBright(`Enter ${chalk.yellow('custom content type name')} (Capitalized or PascalCase):`),
      ...
      },
      {
        name: 'menuName',
        type: 'input',
        message: chalk.blueBright(`Enter custom ${chalk.yellow('menu name')} (Title Case):`),
      ...
      },
      {
        name: 'vendor',
        type: 'input',
        message: chalk.blueBright(`Enter your ${chalk.yellow('vendor name')} (PascalCase):`),
        default: 'MyVendor',
      ...
      },
      {
        name: 'module',
        type: 'input',
        message: chalk.blueBright(`Enter your ${chalk.yellow('module name')} (PascalCase):`),
      ...
      },
      {
        ...
        type: 'input',
        message: chalk.blueBright(`Enter your ${chalk.yellow('module description')}:`),
