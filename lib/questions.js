    ...
    const moduleQuestions = [
      {
        name: 'templateType',
        type: 'list',
        message: chalk.yellow('Extend Page Builder content type OR create custom content type?'),
      ...
      },
      {
        name: 'contentType',
        type: 'list',
        message: chalk.yellow('Choose a content type to extend:'),
      ...
      },
      {
        name: 'contentType',
        type: 'input',
        message: chalk.yellow('Enter custom content type name (Capitalized or PascalCase):'),
      ...
      },
      {
        name: 'menuName',
        type: 'input',
        message: chalk.yellow('Enter custom menu name (Title Case):'),
      ...
      },
      {
        name: 'vendor',
        type: 'input',
        message: chalk.yellow('Enter your vendor name (PascalCase):'),
        default: 'MyVendor',
      ...
      },
      {
        name: 'module',
        type: 'input',
        message: chalk.yellow('Enter your module name (PascalCase):'),
      ...
      },
      {
        ...
        type: 'input',
        message: chalk.yellow('Enter your module description:'),
